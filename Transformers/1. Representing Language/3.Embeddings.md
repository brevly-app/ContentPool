...
Absolutely — this is a *crucial* slide.
The goal here is to make **next-token prediction feel inevitable and natural**, not like a modeling trick.

Below is a **clear, math-light elaboration** that still respects rigor.

---

## The formal goal (without heavy math)

We start with language as a **sequence**:

> w₁, w₂, w₃, …, wₙ

A language model’s job is simple to state:

> **Learn the probability of valid sequences of words**
...
Instead of learning one huge probability, the model learns:
